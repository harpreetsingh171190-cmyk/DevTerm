package com.devterm.shared.android;
...
public class PackageUtils {
    ...
    public static String getSigningCertificateSHA256DigestForPackage(@NonNull final Context context, @NonNull final String packageName) {
        try {
             ...
             * W/PackageManager: Failed to parse /path/to/com.devterm.tasker.apk: Signature mismatch for shared user: SharedUserSetting{xxxxxxx com.devterm/10xxx}
             */
