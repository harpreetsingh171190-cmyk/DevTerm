...
import com.devterm.R;
import com.devterm.app.event.SystemEventReceiver;
import com.devterm.app.terminal.TermuxTerminalSessionActivityClient;
import com.devterm.app.terminal.TermuxTerminalSessionServiceClient;
import com.devterm.shared.termux.plugins.TermuxPluginUtils;
import com.devterm.shared.data.IntentUtils;
import com.devterm.shared.net.uri.UriUtils;
import com.devterm.shared.errors.Errno;
import com.devterm.shared.shell.ShellUtils;
import com.devterm.shared.shell.command.runner.app.AppShell;
import com.devterm.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.devterm.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.devterm.shared.termux.shell.TermuxShellUtils;
import com.devterm.shared.termux.TermuxConstants;
import com.devterm.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_ACTIVITY;
import com.devterm.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.devterm.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.devterm.shared.termux.shell.TermuxShellManager;
import com.devterm.shared.termux.shell.command.runner.terminal.TermuxSession;
import com.devterm.shared.termux.terminal.TermuxTerminalSessionClientBase;
import com.devterm.shared.logger.Logger;
import com.devterm.shared.notification.NotificationUtils;
import com.devterm.shared.android.PermissionUtils;
...
import com.devterm.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.devterm.terminal.TerminalEmulator;
import com.devterm.terminal.TerminalSession;
import com.devterm.terminal.TerminalSessionClient;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.devterm.shared.R.string.error_execution_cancelled))) {
